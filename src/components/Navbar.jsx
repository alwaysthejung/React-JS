  ...
  return (
    ...
    <div className='flex flex-wrap items-center justify-between gap-4 w-full'>
      ...
      <div id="collapseMenu"
        ...
        <ul
          className=' flex lg:!flex lg:gap-x-6 max-lg:space-y-3 max-lg:fixed max-lg:bg-[#151d20] max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
          ...
          <li className='max-lg:border-b max-lg:py-3 px-3'>
            <a href='' className='text-gray-300 hover:text-white text-base flex items-center'>
      ...
      <div className='flex gap-3 max-w-max'>
        <div className='flex items-center max-lg:ml-auto'>
            ...
            className="bg-transparent border border-gray-300 text-sm w-full px-5 text-gray-300 rounded-full py-2 outline-none"></input>
