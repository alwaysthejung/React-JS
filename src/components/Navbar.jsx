...
const Navbar = () => {
  return (
    <>
      <header className='fixed top-0 left-0 w-full bg-gray-950 py-3 px-6 sm:px-10 font-[sans-serif] min-h-[70px] tracking-wide z-50'>
    <div class='flex flex-wrap items-center justify-between gap-4 w-full'>
      ...
      <div id="collapseMenu"
        ...
        <ul
          class=' flex lg:!flex lg:gap-x-6 max-lg:space-y-3 max-lg:fixed max-lg:bg-[#151d20] max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
      ...
      <div className='flex gap-3 max-w-max'>
        <div class='flex items-center max-lg:ml-auto'>
            ...
            class="bg-transparent border border-gray-300 text-sm w-full px-5 text-gray-300 rounded-full py-2 outline-none"></input>
